...
```{r warning=FALSE}
png(filename="diagnostic_plots_ingarch.png", width = 25, height = 20, units = "cm",res=200)
par(mfrow=c(4,5))
...
ggsave(filename = paste("timeseries_ingarch_",distr,"_id_",id,".png",sep=""),plot=p1,height = 15,width = 20)
```
