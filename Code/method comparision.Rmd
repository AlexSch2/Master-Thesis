...
if(save_results){
  save(coda_result,file=here(paste("coda_result_ids",paste(ids,collapse="-"),"win_lgth",frame,".RData",sep="")))
}




for (i in 3:dim(ingarch_settings)[1]){
  ...
  if(save_results){
  save(ingarch_result,file=here(paste("ingarch_result_ids",paste(ids,collapse="-"),"_ext","_",external,
