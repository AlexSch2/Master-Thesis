...
if(save_results){
  save(coda_result,file=here("Code",paste("coda_result_ids",paste(ids,collapse="-"),"_ext","_",external,"win_lgth",frame,".RData",sep="")))
  save(ingarch_result,file=here("Code",paste("ingarch_result_ids",paste(ids,collapse="-"),"_ext","_",external,"win_lgth",frame,".RData",sep="")))
}
```
