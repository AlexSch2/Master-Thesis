...
ingarch_result <-
  ...
  save(ingarch_result,file=here("Code/results",paste("ingarch_result_ids",paste(ids_save,collapse="-"),"_ext","_",external,
                                             ...
                                             "_pobs",past_obs,"_pmeansu",past_mean,".RData",sep="")))
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Both_ErrorMeasure_combined",ids_save,"_ext","_",external,"win_lgth",frame,".png",sep="")),plot=psb,height = 15,width = 20)
}
```
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Both_ErrorMeasure_combined",ids_save,"_ext","_",external,"win_lgth",frame,".png",sep="")),plot=psbs,height = 15,width = 20)
}
```
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Both_ErrorMeasure_combined_zoomed",ids_save,"_ext","_",external,"win_lgth",frame,".png",sep="")),plot=psbs_zoomed,height = 15,width = 20)
}
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Quantile_Plot",ids_save,"_ext","_",external,"win_lgth",frame,".png",sep="")),plot=plot_quant,height = 15,width = 20)
}
```
...
IngarchError_Sorted_split <- model_error_split %>% filter(model=="ingarch")%>%arrange(.,error)
IngarchQuantiles_split  <- quantile(IngarchError_Sorted_split $error,na.rm = T)
IngarchError_Sorted_split $index <- seq(1:dim(IngarchError_Sorted_split )[1])
...
CodaError_Sorted_split $index <- seq(1:dim(CodaError_Sorted_split )[1])


plot_quant_split <- ggplot(IngarchError_Sorted_split ,aes(x=index,y=error,colour=model))+
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Quantile_Plot",ids_save,"_ext","_",external,"win_lgth",frame,".png",sep="")),plot=plot_quant_split,height = 15,width = 20)
}
```
