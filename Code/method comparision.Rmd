...
if(save_results){
  save(coda_result,file=here("Code/result",paste("coda_result_ids",paste(ids,collapse="-"),"win_lgth",frame,".RData",sep="")))
}
...
p8 <- ggplot(plot_mse_cum, aes(y=mse_cumulated,x=window,group=model,col=model))+
