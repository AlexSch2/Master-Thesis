...
The variance function can be generally formulated as $h_{kt} = h(Y_{k,t-1},\ldots,Y_{k,t-p},\bm{a})$ where $\bm{a}$ is the parameter vector and $p \in \mathbbm{N}$ is the order of the ARCH process. 
