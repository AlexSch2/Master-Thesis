...
\begin{equation}
\begin{gathered}
\log(\lambda_{kt}) = \sum_{i=1}^p\beta_i b^k_{ti},\\ %\bm{B}^T_{k,t-1} \bm{\beta},\\
\log\left(\frac{\omega_{t}}{1-\omega_{kt}}\right)=\sum_{i=1}^m\gamma_i z^k_{tj},%\bm{Z}_{k,t-1}^T\bm{\gamma},
