...
Based on this, a joint distribution is constructed using a copula structure and the following process. Take a starting value $\bm{\lambda_0}=(\lambda_{1,0},\ldots,\lambda_{K,0})^T$ and then \cite{Fokianos:2020}
