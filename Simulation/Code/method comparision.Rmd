...
Ingarch03 <- Object.Load("F:/Uni/Masterarbeit/Master-Thesis_git/Simulation/Code/results/ingarch_result_ids_all_frame03.RData")
...
Coda_Combined <- rbind(Coda0$result,Coda1$result,Coda07$result)
Ingarch_Combined <- rbind(Ingarch03$result,Ingarch07$result,Ingarch05$result)
