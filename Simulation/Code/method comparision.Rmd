...
if(save_results){
  save(coda_result,file=here("Code/results",paste("coda_result_ids",paste(ids_save,collapse="-"),"dl05",".RData",sep="")))
}
...
Plot.TimeseriesMultiple(weekly_category_data,AllResult,Id=c(100402,100403,100191),File_Prefix= "CodaIngarchInar")
