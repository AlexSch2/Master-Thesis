...
if(save_results){
  save(coda_result,file=here("Code/results",paste("coda_result_ids",paste(ids_save,collapse="-"),"_frame_method_",window_method,".RData",sep="")))
}
...
ingarch_result <-
  ...
  if(save_results){
  save(ingarch_result,file=here("Code/results",paste("ingarch_result_ids",paste(ids_save,collapse="-"),"_frame_method_",window_method,".RData",sep="")))
...
Plot.ErrorMeasureCombined(CodaCombined = Coda_Combined,IngarchCombined = Ingarch_Combined,Values=c("extending","overlapping"),Split=F,Variation = "windowMethod")
