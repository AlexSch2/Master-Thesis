...
ingarch_model_error <- Model.Error(ingarch_result,Fnct = "Mse",Category = Category ) %>% 
                       Model.ErrorOverall(Fnct = "sum",SplitByGroup = F,Category = Category )

ingarch_model_error_split <- Model.Error(ingarch_result,Fnct = "Mse",Category =Category ) %>% 
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Quantile_Plot_Split",ids_save,"_histlgth",HistoryLength,"win_lgth",frame,"_maincat",MainCat,".png",sep="")),
...
if(save_plots){
  ggsave(filename = here("Plots",paste("Quantile_Plot",ids_save,"_histlgth",HistoryLength,"win_lgth",frame,"_maincat",MainCat,".png",sep="")),
